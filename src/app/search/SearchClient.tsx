...
export default function SearchClient() {
  ...
  useEffect(() => {
    ...
    debounceRef.current = setTimeout(() => fetchTmdb(query, selectedType), 420);
    ...
    <main className="min-h-screen bg-ink pb-16">
      ...
      <section className="px-4 py-8 md:px-8">
        ...
        <p className="mt-5 text-sm text-zinc-400">
          ...
          {hasQuery && !loading && dedupedTmdb.length > 0 && !apiError && (
        ...
        {allResults.length > 0 ? (
          ...
          !loading && searched && (
            <div className="mt-16 text-center text-zinc-500">
              <p className="text-lg font-bold">No results for &ldquo;{query}&rdquo;</p>
